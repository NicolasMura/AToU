  ...
  echo "
    <script>
      ...
      $('a[name=\"FR\"]').click(function()
        {
          $(\"#drapeau-france\").attr(\"src\", \"".CHEMIN_SITE."/img/drapeau-france.png\"); // on charge le drapeau français
          $(\"#drapeau-angleterre\").attr(\"src\", \"".CHEMIN_SITE."/img/drapeau-angleterre-nb.png\"); // on charge le drapeau anglais en N&B
          $('a[name=\"FR\"]').css({
            fontWeight: 'bold'
          });
          $('a[name=\"EN\"]').css({
      ...
      $('a[name=\"EN\"]').click(function()
        {
          $(\"#drapeau-france\").attr(\"src\", \"".CHEMIN_SITE."/img/drapeau-france-nb.png\"); // on charge le drapeau français N&B
          $(\"#drapeau-angleterre\").attr(\"src\", \"".CHEMIN_SITE."/img/drapeau-angleterre.png\"); // on charge le drapeau anglais
          $('a[name=\"FR\"]').css({
            fontWeight: 'normal'
          });
          $('a[name=\"EN\"]').css({
