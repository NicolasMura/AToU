...
-- Généré le: Sam 26 Avril 2014 à 14:29
...
(3, 'Les ateliers Atou', 'Festiv'' Amphis\r\nVen. 27 juin\r\n19h30', 'mobile_actu_les-ateliers-atou.jpg'),
...
(39, '', 'Le Progrès', '2013-06-24', 'action_transforme_article_presse_39.pdf', 0, 4),
(38, '', 'Lyon Est', '2014-01-01', 'action_transforme_article_presse_1.pdf', 0, 4),
...
(34, '', 'Le Progrès', '2012-06-22', 'action_bab-el-bal_article_presse_1.pdf', 0, 6),
(35, '', 'Le Progrès', '2012-08-18', 'action_bab-el-bal_article_presse_35.pdf', 0, 6),
(36, '', 'Le journal de Vaulx-en-Velin', '2012-09-19', 'action_bab-el-bal_article_presse_36.pdf', 0, 6),
(37, '', 'Le journal de Vaulx-en-Velin', '2012-10-25', 'action_bab-el-bal_article_presse_37.pdf', 0, 6),
(40, '', 'Le journal de Vaulx-en-Velin', '2013-06-19', 'action_transforme_article_presse_40.pdf', 0, 4),
(41, '', 'Le journal de Vaulx-en-Velin', '2013-05-02', 'action_transforme_article_presse_41.pdf', 0, 4),
(42, '', 'Le Progrès', '2013-05-15', 'action_transforme_article_presse_42.pdf', 0, 4),
(43, '', 'Le journal de Vaulx-en-Velin', '2012-09-19', 'action_atou-tohoku-project_article_presse_1.pdf', 0, 7);
...
(197, 'Photo de l''action culturelle BAB-EL-BAL', 'action_bab-el-bal_1.jpg', 0, 6),
(198, 'Photo de l''action culturelle bab-el-bal', 'action_bab-el-bal_198.jpg', 0, 6);
...
CREATE TABLE IF NOT EXISTS `representations` (
  ...
  `heureDebut` time NOT NULL,
  `infos` varchar(100) NOT NULL,
  `infosMobile` varchar(1000) NOT NULL,
  `adresseGpsDuLieu` varchar(100) NOT NULL,
  `infosMetro` text NOT NULL,
  `infosBus` text NOT NULL,
  `infosVoiture` text NOT NULL,
...
INSERT INTO `representations` (`ID`, `salle`, `ville`, `pays`, `dates`, `heureDebut`, `infos`, `infosMobile`, `adresseGpsDuLieu`, `infosMetro`, `infosBus`, `infosVoiture`, `creationsID`, `actions_culturellesID`) VALUES
...
(48, 'Théâtre d''Auxerre', 'Auxerre', 'France', '2015-02-03', '20:30:00', 'Réservation sur le site www.auxerreletheatre.com  54 rue Joubert 89000 Auxerre', '', '47.795038,3.57345', '', '', '', 1, 0),
(49, 'Théâtre Louis Jouvet', 'Rethel', 'France', '2015-01-06', '20:30:00', 'Réservation sur le site : www.theatrelouisjouvet.fr 16 place de Caen 08300 Rethel', 'Prochainement :<br><br>Réservation à partir de septembre 2014 sur le site http://theatre-astree.univ-lyon1.fr<br><br>Par téléphone du lundi au jeudi de 10h à 12h et de 14h à 17h<br><br><b><u><span style="color:rgb(0,0,0);">+33(0)472447945</span></u></b><br><br>ou<br><br><u><b><span style="color:rgb(0,0,0);">+33(0)472431911</span></b></u><br><br>Par mail :<br><br><span style="color:rgb(0,0,0);"><span style="color: rgb(0, 0, 0);"><b style="color: rgb(0, 0, 0);"><u style="color: rgb(0, 0, 0);">mission.culture@univ-lyon1.fr</u></b></span><br style="color: rgb(0, 0, 0);"></span><br>', 'zsfdv', '', '', '', 1, 0),
...
(54, 'Centre culturel Charlie Chaplin', 'Vaulx-en-Velin', 'France', '2014-11-05', '19:30:00', 'Place de la Nation - 69120 Vaulx-en-Velin Réservation: Tél. : 04 72 04 81 18 ou 04 72 04 81 19 ou en', '', ' ', '', '', '', 30, 0);
