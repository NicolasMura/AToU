...
--
-- Client: localhost
-- Généré le: Sam 19 Avril 2014 à 13:32
...
INSERT INTO `actions_culturelles` (`ID`, `titre`, `titreBloc`, `chapo`, `interTitre`, `auteur`, `resume`, `resumeMobile`, `accroche`, `anneeCreation`, `duree`, `statut`, `notesTitre`, `notesTexte`, `notesAuteur`, `urlVideo`, `urlPresse`, `urlFiche`, `photosID`, `articlesID`, `representationsID`, `active`) VALUES
(4, 'TransFORME', '', 'Créer, sensibiliser, tisser du lien', 'Votre message ici', '', 'Au delà d’une recherche esthétique dans laquelle trop souvent elle se retrouve enfermée, la danse est un solide outil de recherche personnelle, d’expression intime et de partage. AToU s’attache à faire découvrir cette facette au plus grand nombre, sous forme de rencontres publiques, d’ateliers hebdomadaires ou de stages sur plusieurs jours. Les séances sont toujours en lien avec le travail artistique de la compagnie et conduisent généralement à une création collective avec les participants.', 'Votre message ici', 'Votre message ici', 2010, '', 'actionPresente', '', 'Votre message ici', '', '84222615', '', '', 0, 0, 0, 0);
...
(17, '', 'test', '2014-04-16', 'creation_shinmu_article_presse_1.pdf', 1, 0);
...
INSERT INTO `fiche` (`ID`, `titre`, `urlFiche`, `creationsID`, `actions_culturellesID`) VALUES
(17, 'test', 'creation_shinmu_fiche.pdf', 1, 0);
...
(106, 'Photo de l''action culturelle TransFORME', 'action_transforme_1.jpg', 0, 4),
...
(75, 'Photo de la galerie', 'galerie_1.jpg', 0, 0),
(104, 'Photo de la création ShiNMu', 'creation_shinmu_85.jpg', 1, 0);
...
(38, 'test', 'test', 'test', '2014-04-17', '', '', '', '', 1);
