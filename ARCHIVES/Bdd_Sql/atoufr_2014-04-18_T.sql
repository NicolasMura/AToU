...
--
-- Client: localhost
-- Généré le: Ven 18 Avril 2014 à 09:46
...
(1, 'Backoffice Office', 'rfregrtgr', '', '', 'Moi', '', '', '', 2015, '62 minutes', '', 'grtegertg', '', 'rgertg', 'gtregrteg', 'rtgrtg', 'egrtgerg', 0, 0, 0),
(3, 'News', 'erhrth', '', '', 'rtehrt', '', '', '\r\n    ', 2015, '60 mionutes', '', 'rhreht', '', 'rthrthet', 'rthrtyhe', 'rheerh', 'rhther', 0, 0, 0);
...
(16, 'test', 'creation_shinmu_dossier_presse.pdf', 1, 0);
...
(89, 'Photo de l''action culturelle News', 'action_news_1.jpg', 0, 3),
