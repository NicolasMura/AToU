...
--
-- Client: localhost
-- Généré le: Mar 22 Avril 2014 à 17:15
...
(32, 'Vagne', 'Cécile', '', '', '', 'cecile.vagne@hotmail.fr', '', 'cecile', 'vagne', '', 'adherent', '0000-00-00'),
(33, 'Bellon-Gronnier', 'Roger', '', '', '', 'rbellongronnier@gmail.com', '', 'roger', 'bellon', '', 'adherent', '0000-00-00'),
(34, 'Dubois', 'Manon', '', '', '', 'manondubois@hotmail.fr', '', 'manon', 'dubois', '', 'adherent', '0000-00-00');
...
INSERT INTO `ateliers` (`ID`, `titre`, `salle`, `texte`, `texteMobile`, `dates`, `heureDebut`, `heureFin`, `adresse`, `codePostal`, `ville`, `adresseGpsDuLieu`, `filenamePhotoMobile`) VALUES
(1, 'Autour de Nubes', '', 'Description', 'Description mobile', '2014-04-26', '00:00:00', '00:00:00', '4 avenue Bataillon Carmagnole – 69120 Vaulx en Velin', '', '', '', '');
...
(56, '2014-04-26', '00:00:00', '00:00:00', 0);
...
INSERT INTO `representations` (`ID`, `salle`, `ville`, `pays`, `dates`, `heureDebut`, `adresseGpsDuLieu`, `infosMetro`, `infosBus`, `infosVoiture`, `creationsID`, `actions_culturellesID`) VALUES
...
(48, 'test2', 'test2', 'test2', '2014-04-24', '05:04:00', 'test2', '', '', '', 1, 0),
(49, 'sdqflih', 'fdsiluh', 'slfiuh', '2014-04-24', '12:05:00', 'zsfdv', '', '', '', 1, 0);
